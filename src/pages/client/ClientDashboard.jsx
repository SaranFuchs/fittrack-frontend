...
export function ClientDashboard() {
  ...
  const caloriesOver = nutrition.data.remaining.calories < 0
  const calorieBalance = caloriesOver ? `+${Math.abs(nutrition.data.remaining.calories)}` : nutrition.data.remaining.calories
